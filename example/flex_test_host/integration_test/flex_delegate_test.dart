...
void main() {
  ...
  group('FlexDelegate', () {
    ...
    testWidgets('inference with FlexDelegate works', (tester) async {
      ...
      // Untrained model, w=0 b=0; output should be close to 0.
    ...
    testWidgets('multiple concurrent delegates work independently', (
      ...
      // Create two delegates simultaneously, exercising the iOS map storage
      // where each delegate is tracked as a separate entry.
